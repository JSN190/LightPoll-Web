<template>
  <div id="main-poll-card" class="card">
    ...
    <footer class="card-footer">
      <div v-on:click="submitVote" class="footer-container">
        <i class="far fa-paper-plane"></i><span>Cast my vote</span>
      </div>
      <div v-on:click="loadingBar.finish()">
        <router-link
          :to="`/poll/${$route.params.id}/results`"
          class="footer-container"
          ><i class="fas fa-table"></i
          ><span>View the results</span></router-link
        >
      </div>
    </footer>
  </div>
